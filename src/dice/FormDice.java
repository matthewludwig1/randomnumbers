 ...
 * Matthew Ludwig
 * March 20 2018
 * This program generates random numbers when a button is pushed
 */
...
public class FormDice extends javax.swing.JFrame {
    ...
    private void RollButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_RollButtonActionPerformed
        ...
        die1Value = (int)Math.ceil(Math.random()*20);     
        die2Value = (int)Math.floor(Math.random()*20);
        
        
         
                
        double value1 = 20,value2 = 5;
        System.out.println( Math.floor(Math.random() * (value1-value2+1) + value2) );
